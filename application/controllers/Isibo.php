...
class Isibo extends CI_Controller {
	...
	public function imiryango(){
		$this->load->view('isibo/header');
		$this->load->view('isibo/sidebar');
		$this->load->view('isibo/imiryango');
		$this->load->view('isibo/footer');
	}
	public function abagabo(){
		$this->load->view('isibo/header');
		$this->load->view('isibo/sidebar');
		$this->load->view('isibo/abagabo');
		$this->load->view('isibo/footer');
	}
	public function urubyiruko(){
		$this->load->view('isibo/header');
		$this->load->view('isibo/sidebar');
		$this->load->view('isibo/urubyiruko');
		$this->load->view('isibo/footer');
	}
	public function abana(){
		$this->load->view('isibo/header');
		$this->load->view('isibo/sidebar');
		$this->load->view('isibo/abana');
		$this->load->view('isibo/footer');
	}
	public function abagore(){
		$this->load->view('isibo/header');
		$this->load->view('isibo/sidebar');
		$this->load->view('isibo/abagore');
		$this->load->view('isibo/footer');
	}
	...
	public function abaturage(){
		$this->load->view('isibo/header');
		$this->load->view('isibo/sidebar');
		$this->load->view('isibo/abaturage');
	}
	public function kureba_umuryango(){
		$this->load->view('isibo/header');
		$this->load->view('isibo/sidebar');
		$this->load->view('isibo/kureba_umuryango');
		$this->load->view('isibo/footer');
	}
