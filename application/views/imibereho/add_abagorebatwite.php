                            ...
                            <div class="statbox widget box box-shadow">
                                ...
                                <div style="color:#000; font-weight:bold" class="widget-content widget-content-area">
                                    <form>
                                        ...
                                        <div class="form-group mb-4">
                                            <label style="color:#000;" for="exampleFormControlInput2">ITARIKI YOKWIPIMISHA</label>
                                            <input type="date" class="form-control" id="exampleFormControlInput2" placeholder="">
                                        </div>
                                        <div class="form-group mb-4">
