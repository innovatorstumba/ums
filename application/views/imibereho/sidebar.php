    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu md-visible">
                <a href="<?=base_url()?>imibereho/chat" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <a href="#umuganda" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                ...
                <ul class="collapse submenu list-unstyled" id="umuganda" data-parent="#accordionExample">
                    <li>
                        <a href="<?=base_url()?>imibereho/umuganda"> Kureba Imiganda </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>imibereho/kuzuza_umuganda"> Kuzuza Umuganda  </a>
                    </li>
            ...
            <a href="#starter-kit" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                ...
                <ul class="collapse submenu list-unstyled" id="starter-kit" data-parent="#accordionExample">
                    <li>
                        <a href="<?=base_url()?>imibereho/ayaleta"> Ayaleta </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>imibereho/amatangazo"> Ayokurangisha  </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>imibereho/ibyaranzwe"> Ibyaranzwe  </a>
                    </li>                      
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="components" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="<?=base_url()?>imibereho/imiryango"> Kureba Imiryango </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>imibereho/abagabo"> Abagabo</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>imibereho/abagore"> Abagore</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>imibereho/abana"> Abana</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>imibereho/urubyiruko"> Urubyiruko</a>
                    </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="elements" data-parent="#accordionExample">
                    <li>
                        <a href="<?=base_url()?>imibereho/guhindura_umwirondoro"> Ifoto Ikuranga </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>imibereho/citizen"> Umwirondoro wanjye </a>
                    </li>
                  
                </ul>
            </li>
            <li class="menu">
                <a href="<?=base_url()?>imibereho/abaturage" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="forms" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="<?=base_url()?>imibereho/akagoroba"> Umugoroba w'ababyeyi </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>imibereho/isuku"> Umusanzu w'isuku</a>
                    </li>
                </ul>
            </li>
            <li class="menu">
                <a href="#abagore" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                    <i class="fas fa-luggage-cart" style="font-size:16px;color:blue;"><span style="color:#000; padding-left:20px; font-family: Roboto, 'Segoe UI', Tahoma, sans-serif;">Abagore batwite<span></i>                        
                ...
                <ul class="collapse submenu list-unstyled" id="abagore" data-parent="#accordionExample">
                
                    <li>
                        <a href="<?=base_url()?>imibereho/abagore_batwite"> Kureba abatwite </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>imibereho/add_abagorebatwite"> Kwandika abatwite</a>
                    </li>
                </ul>
            </li>
