                                ...
                                <div class="widget-header">                                
                                    <div class="row">
                                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                            <h4 style="font-family:Sans-serif; text-align:center; text-transform:none; color:#000; font-weight:bold">UZUZA NEZA IBYIBWE</h4>
                                        </div>
                                    </div>
                                </div>
                                <div style="color:#000; font-weight:bold" class="widget-content widget-content-area">
                                    <form>
                                        <div class="form-group mb-4">
                                            <label style="color:#000;" for="exampleFormControlInput2">ICYIBWE</label>
                                            <input type="email" class="form-control" id="exampleFormControlInput2" placeholder="ICYIBWE">
                                        </div>
                                        ...
                                        <div class="form-group mb-4 mt-3">
                                            <label style="color:#000;" for="exampleFormControlFile1">IFOTO Y'ICYIBWE</label>
