                            ...
                            <table id="default-ordering" border=1  style="width:100%; color:#000; font-family:arial">
                                <thead>
                                    <tr style="background-color:#f1f1f1"><th>No</th>
                                        ...
                                        <th>AHO AKOMOKA</th>
                                        <th>IRANGAMUNTU</th>
                                        <th>ITALIKI Y'AHAGEREYE</th>
                                        <th>ITALIKI Y'ATAHIYE</th>
                                        <th>TELEPHONE</th>
                                    </tr>
                                </thead>
                                <tbody>
                                  ...
                                  foreach ($data as $value) {
                                    ...
                                    ?>                                    
                                    <tr><td><?=$cnt?></td>
                                        <td><?=$value->ldr_firstname?></td>
                                        <td><?=$value->gue_firstname?></td>
                                        <td><?=$value->gue_address?></td>
                                        <td><?=$value->gue_nid?></td>
                                        <td><?=$value->gue_registered_date?></td>
                                        <td><?=$value->gue_dismissed_date?></td>
                                        <td><?=$value->gue_phone?></td>
                                    </tr>
                                    <?php
                                  }
                                  ?>
                                ...
                                <th>UMURYANGO</th>
                                        ...
                                        <th>AHO AKOMOKA</th>
                                        <th>IRANGAMUNTU</th>
                                        <th>ITALIKI Y'ITALIKI Y'AHAGEREYE</th>
                                        <th>ITALIKI Y'ATAHIYE</th>
                                        <th>TELEPHONE</th>
                                    </tr>
                                </tfoot>
