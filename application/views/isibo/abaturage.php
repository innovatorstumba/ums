   ...
   <link rel="icon" type="image/x-icon" href="<?=base_url()?>assets/assets/img/favicon.ico"/>
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/plugins/table/datatable/custom_dt_miscellaneous.css">
...
.panel-body {
 ...
 <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                <div style="margin-top:-20px" class="seperator-header layout-top-spacing">
                </div>
                            ...
                            <div class="widget-content widget-content-area">
                                <div class="table-form">
                                    <div class="form-group row mr-3">
                                        <label for="min" class="col-sm-3 col-form-label col-form-label-sm"> Kuva:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control form-control-sm" name="min" id="min" placeholder="Andika imyaka">
                                        </div>
                                    </div>
    
                                    <div class="form-group row">
                                        <label for="max" class="col-sm-3 col-form-label col-form-label-sm">Kugera:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control form-control-sm" name="max" id="max" placeholder="Andika imyaka">
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="<?=base_url()?>assets/plugins/table/datatable/custom_miscellaneous.js"></script>
