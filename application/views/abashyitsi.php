                            ...
                            if ($selected != null){
                                ...
                                <table id="default-ordering" border=1  style="width:100%; color:#000; font-family:arial">
                                    ...
                                    foreach ($selected as $row){
                                        ...
                                        ?>
                                        <tr><td><?=$x;?></td>
                                            <td><?=$row->gue_firstname.' '.$row->gue_lastname;?></td>
                                            <td><?=$row->gue_address;?></td>
                                            <td><?=$row->gue_nid;?></td>
                                            <td><?=date('d-M-Y', $row->gue_registered_date)?></td>
                                            <td><?=$row->gue_phone;?></td>
                                            <td><?=$row->gue_status;?></td>
                                            <?php
                                            if ($row->gue_status == 'Active'){
                                                ?>
                                                <td><a class="btn btn-outline-dark" href="<?=base_url();?>family/dismiss/<?=$row->gue_id;?>" onclick="return confirm('Emeza niba koko umushyitsi umusezereye?')">Kumusezerera</a></td>
                                                <?php
                                            } else{
                                                ?>
                                                <td><a class="btn btn-outline-dark"  disabled>Kumusezerera</a></td>
                                                <?php
                                            }
                                            ?>
                                        </tr>
                                ...
                                <div class="infobox-1">
                                    ...
                                    <h5 class="info-heading">Nta Mushyitsi n'umwe wari wakira ukoresheje iyi system.</h5>
