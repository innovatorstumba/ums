				...
				<div class="col-md-9" style="padding-right:30px" >
					<div class="social-feed-box" >
						...
						<div class="panel-body">
							<textarea class="form-control" rows="1" placeholder="Andika Igitekerezo Cyawe" style="height:50px;padding-top:10px; border-radius:30px;background-color:#fff; color:#000; font-weight:bold; font-size:16px; margin:10px"></textarea>
							<div class="mar-top clearfix" style="margin-left:15px">
								<button class="btn btn-sm btn-primary pull-right" type="submit"><i class="fa fa-share-alt"></i> Ohereza</button>
								<a class="btn btn-trans btn-icon fa fa-camera add-tooltip" style="color:blue; margin:5px" href="#" data-original-title="Add Photo" data-toggle="tooltip"> Amafoto</a>
								<a class="btn btn-trans btn-icon fa fa-video-camera add-tooltip" style="color:red; margin:5px" href="#" data-original-title="Add Video" data-toggle="tooltip"> Video</a>
								<a class="btn btn-trans btn-icon fa fa-file add-tooltip" style="color:green; margin:5px" href="#" data-original-title="Add File" data-toggle="tooltip"> Add File</a>
							</div>
						</div>
					...
					<div class="social-feed-box">
						...
						<div class="social-footer">
							<div class="social-comment">
								<a href="" class="pull-left">
									<img alt="image" src="<?=base_url()?>assets/assets/img/profile2.jpg">                </a>
								<div class="media-body">
									<a href="#">
										Andrew Williams
									</a>
							...
							<div class="social-comment">
								<a href="" class="pull-left">
									<img alt="image" src="<?=base_url()?>assets/assets/img/profile3.jpg">                </a>
								<div class="media-body">
									<textarea class="form-control" placeholder="Write comment..."></textarea>
								</div>
							</div>
					...
					<div class="social-feed-box">
						...
						<div class="social-body">
							...
							<img src="<?=base_url()?>assets/assets/img/verr.jpg" class="img-responsive">
							<div class="btn-group">
								<button class="btn btn-white btn-xs"><i class="fa fa-thumbs-up"></i> Like this!</button>
								<button class="btn btn-white btn-xs"><i class="fa fa-comments"></i> Comment</button>
								<button class="btn btn-white btn-xs"><i class="fa fa-share"></i> Share</button>
