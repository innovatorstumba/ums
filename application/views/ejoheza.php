                        ...
                        <table id="invoice-list" class="table table-hover" style="width:100%">
                            ...
                            foreach ($selected->result() as $row){
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?=base_url();?>Family/invoice/ejoheza/<?=$row->ejo_transaction_id;?>/"><span class="inv-number"><?=$row->ejo_transaction_id;?></span></a></td>
                                    <td>
                                        <div class="d-flex">
                                    ...
                                    <td><span class="inv-date"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>  <?=date('d-M-Y', $row->ejo_date)?></span></td>
                                    <td><?=$row->ejo_year;?></td>
                                    <td><?=$row->ejo_months;?></td>
