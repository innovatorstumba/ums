    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu md-visible">
                <a href="<?=base_url()?>umutekano/chat" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <a href="#umuganda" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                ...
                <ul class="collapse submenu list-unstyled" id="umuganda" data-parent="#accordionExample">
                    <li>
                        <a href="<?=base_url()?>umutekano/umuganda"> Kureba Imiganda </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umutekano/kuzuza_umuganda"> Kuzuza Umuganda  </a>
                    </li>
            ...
            <a href="#starter-kit" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                ...
                <ul class="collapse submenu list-unstyled" id="starter-kit" data-parent="#accordionExample">
                    <li>
                        <a href="<?=base_url()?>umutekano/ayaleta"> Ayaleta </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umutekano/amatangazo"> Ayokurangisha  </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umutekano/ibyaranzwe"> Ibyaranzwe  </a>
                    </li>                      
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="components" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="<?=base_url()?>umutekano/imiryango"> Kureba Imiryango </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umutekano/abagabo"> Abagabo</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umutekano/abagore"> Abagore</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umutekano/abana"> Abana</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umutekano/urubyiruko"> Urubyiruko</a>
                    </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="elements" data-parent="#accordionExample">
                    <li>
                        <a href="<?=base_url()?>umutekano/guhindura_umwirondoro"> Ifoto Ikuranga </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umutekano/citizen"> Umwirondoro wanjye </a>
                    </li>
                  
                </ul>
            </li>
            <li class="menu">
                <a href="<?=base_url()?>umutekano/abaturage" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="datatables" data-parent="#accordionExample">
                    <li>
                        <a href="<?=base_url()?>umutekano/abashyitsi"> Abashyitsi</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umutekano/ibyibwe"> Ibyibwe</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umutekano/ayaleta"> Amatangazo y'umutekano</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umutekano/umutekano"> Umusanzu W'umutekano</a>
                    </li>
