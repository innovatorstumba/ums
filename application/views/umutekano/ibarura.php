                                ...
                                <div class="widget-header">                                
                                    <div class="row">
                                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                            <h4 style="font-family:Sans-serif; text-align:center; text-transform:none; color:#000; font-weight:bold">SUBIZA NEZA HANO IBISABWA</h4>
                                        </div>
                                    </div>
                                </div>
                                <div style="color:#000; font-weight:bold" class="widget-content widget-content-area">
                                    <form>
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="email" class="form-control" id="exampleFormControlInput2" placeholder="UHAGARARIYE UMURYANGO">
                                        </div>
                                        <div class="form-group mb-4">
                                            <label for="exampleFormControlSelect1">Ucana ukoresheje iki?</label>
                                            <select class="form-control" id="exampleFormControlSelect1">
                                            <option>--HITAMO--</option>   
                                            <option>GAS</option>
                                                <option>AMAKARA</option>
                                                <option>INKWI</option>
                                                <option>AMASHANYARAZI</option>
