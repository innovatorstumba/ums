                                ...
                                <div class="widget-header">                                
                                    <div class="row">
                                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                            <h4 style="font-family:Sans-serif; text-align:center; text-transform:none; color:#000; font-weight:bold">UZUZA NEZA IMIHIGO YAWE</h4>
                                        </div>
                                    </div>
                                </div>
                                <div style="color:#000; font-weight:bold" class="widget-content widget-content-area">
                                    <form>
                                        <div class="form-group mb-4">
                                            <label style="color:#000;" for="exampleFormControlInput2">Itariki yo guhigura</label>
                                            <input type="date" class="form-control" id="exampleFormControlInput2" placeholder="italiki">
                                        </div>
 
                                        <div class="form-group mb-4">
                                            <label style="color:#000;" for="exampleFormControlTextarea1">Ibyo uhiga</label>
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                        </div>
                                        
                                        <input type="submit" value="Ohereza Umuhigo" name="time" class="mt-4 mb-4 btn btn-primary">
                                    </form>
                                </div>
                            </div>
                        </div>
