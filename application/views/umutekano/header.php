        ...
        <header style="background-color:#fff; color:#000" class="header navbar navbar-expand-sm">
            ...
            <ul style="background:#F0F0F0;color:#000" class="navbar-nav theme-brand flex-row  text-center">
                ...
                <li class="nav-item theme-text" >
                    <a href="<?=base_url()?>umutekano/" style="font-size:14px;color:#000" class="nav-link"> Dadoh Bernard </a>
                </li>
            ...
            <ul class="navbar-item flex-row navbar-dropdown" style="background-color:#fff; color:#000">
                <li class="nav-item dropdown apps-dropdown more-dropdown md-hidden" style="background-color:#fff; color:#000">
                    <div class="dropdown  custom-dropdown-icon" style="background-color:#fff; color:#000">
						...
						<a href="<?=base_url()?>umutekano/amashuri"><i class="fas fa-graduation-cap" style="font-size:16px;color:blue;padding-left:0px"><span style="color:#000; padding-left:10px">Amashuri<span></i>  </a>
						<a href="<?=base_url()?>umutekano/amavuriro"><i class="fas fa-hospital" style="font-size:16px;color:orange;padding-left:0px"><span style="color:#000; padding-left:10px">Amavuriro<span></i>      </a>
						<a href="<?=base_url()?>umutekano/pharmacy"><i class="fas fa-plus-square" style="font-size:16px;color:green;padding-left:0px"><span style="color:#000; padding-left:10px">Pharmacy<span></i>     </a>
						<a href="<?=base_url()?>umutekano/restaurant"><i class="fas fa-hamburger" style="font-size:16px;color:#E85959;padding-left:0px"><span style="color:#000; padding-left:10px">Restaurent<span></i>    </a>
						<a href="<?=base_url()?>umutekano/utubari"><i class="fas fa-glass-cheers" style="font-size:16px;color:#F17421;padding-left:0px"><span style="color:#000; padding-left:10px">Utubari<span></i>    </a>
						<a href="<?=base_url()?>umutekano/inganda"><i class="fas fa-industry" style="font-size:16px;color:blue;padding-left:0px"><span style="color:#000; padding-left:10px">Inganda<span></i>            </a>
						<a href="<?=base_url()?>umutekano/amasoko"><i class="fas fa-store" style="font-size:16px;color:#82C91E;padding-left:0px"><span style="color:#000; padding-left:10px">Amasoko<span></i>            </a>
						<a href="<?=base_url()?>umutekano/abashyitsi/amaduka"><i class="fas fa-store-alt" style="font-size:16px;color:blue;padding-left:0px"><span style="color:#000; padding-left:10px">Amaduka<span></i>           </a>
						<a href="<?=base_url()?>umutekano/cooperative"><i class="fas fa-store-alt" style="font-size:16px;color:blue;padding-left:0px"><span style="color:#000; padding-left:10px">cooperative<span></i>   </a>
						<a href="<?=base_url()?>umutekano/salon_de_coiffure"><i class="fas fa-store-alt" style="font-size:16px;color:blue;padding-left:0px"><span style="color:#000; padding-left:10px">Salon<span></i></a>
						<a href="<?=base_url()?>umutekano/amabanki"><i class="fas fa-store-alt" style="font-size:16px;color:blue;padding-left:0px"><span style="color:#000; padding-left:10px">Amabanki<span></i>   </a>
						<a href="<?=base_url()?>umutekano/insengero"><i class="fas fa-store-alt" style="font-size:16px;color:blue;padding-left:0px"><span style="color:#000; padding-left:10px">insengero<span></i>   </a>
						<a href="<?=base_url()?>umutekano/hoteli"><i class="fas fa-store-alt" style="font-size:16px;color:blue;padding-left:0px"><span style="color:#000; padding-left:10px">hoteli<span></i>   </a>
            ...
            <ul class="navbar-item flex-row navbar-dropdown" style="background-color:transparent; color:#000">
                <li class="nav-item dropdown apps-dropdown more-dropdown md-hidden" style="background-color:#fff; color:#000">
                    ...
                    <a class="btn btn-trans btn-icon  add-tooltip" style="color:black; background-color:#fff; box-shadow: none; margin:1px;" href="<?=base_url()?>umutekano/abashyitsi" data-original-title="Add Photo" data-toggle="tooltip"><b style="font-family: Roboto, 'Segoe UI', Tahoma, sans-serif;"><span class="fas fa-store-alt" style="font-size:28px"></span> </b></a>
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="appSection">
            ...
            <ul class="navbar-item flex-row navbar-dropdown" style="background-color:transparent; color:#000">
                <li class="nav-item dropdown apps-dropdown more-dropdown md-hidden" style="background-color:#fff; color:#000">
                    <div class="dropdown  custom-dropdown-icon" style="background-color:transparent; color:#fff">
                    <a class="btn btn-trans btn-icon add-tooltip" style="color:black; background-color:#fff; box-shadow: none; margin:1px" href="<?=base_url()?>umutekano/abaturage" data-original-title="Add Photo" data-toggle="tooltip"><b style="font-family: Roboto, 'Segoe UI', Tahoma, sans-serif;"><span class="fa fa-trophy" style="font-size:32px"></span> </b></a>
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="appSection">
            ...
            <ul class="navbar-item flex-row navbar-dropdown" style="background-color:transparent; color:#000">
                <li class="nav-item dropdown apps-dropdown more-dropdown md-hidden" style="background-color:#fff; color:#000">
                    <div class="dropdown  custom-dropdown-icon" style="background-color:transparent; color:#fff">
                    <a class="btn btn-trans btn-icon add-tooltip" style="color:black; background-color:#fff; box-shadow: none; margin:1px" href="<?=base_url()?>umutekano/umutekano" data-original-title="Add Photo" data-toggle="tooltip"><b style="font-family: Roboto, 'Segoe UI', Tahoma, sans-serif;"><span class="fas fa-wallet" style="font-size:28px"></span> </b></a>
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="appSection">
