                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    <form id="general-info" class="section general-info">
                                        <div class="info">
                                            <h6 class="">Umwirondoro wanjye</h6>
                                            <div class="row">
                                                <div class="col-lg-11 mx-auto">
                                                    <div class="row">
                                                        <div class="col-xl-2 col-lg-12 col-md-4">
                                                            <div class="upload mt-4 pr-md-4">
                                                                <input type="file" id="input-file-max-fs" class="dropify" data-default-file="<?=base_url()?>assets/assets/img/dadoh.png" data-max-file-size="2M" /><br>
                                                                <p class="mt-2"><i class="flaticon-cloud-upload mr-1"></i> Hindura ifoto</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-10 col-lg-12 col-md-8 mt-md-0 mt-4">
                                                            <div class="form">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4" id="fullName" placeholder="Full Name" value="dadoh bernard">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="profession">Iby'ukora</label>
                                                                    <input type="text" class="form-control mb-4" id="profession" placeholder="Designer" value="Umucamanza">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
My job is to build your website so that it is functional and user-friendly but at the same time attractive. Moreover, I add personal touch to your product and make sure that is eye-catching and easy to use. My aim is to bring across your message and identity in the most creative way. I created web design for many famous brand companies.</textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-11 mx-auto">
                                                    ...
                                                    <div class="platform-div">
                                                        <div class="form-group">
                                                            <label for="platform-title">Umutwe wamagambo</label>
                                                            <input type="text" class="form-control mb-4" id="platform-title" placeholder="Platforms Title" value="Umwubatsi" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="platform-description">Ubusobanuro</label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control mb-4" id="address" placeholder="Address" value="Kigali, Gasabo" >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control mb-4" id="phone" placeholder="Write your phone number here" value="+25078555-12121">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="email">Email</label>
                                                                <input type="text" class="form-control mb-4" id="email" placeholder="Write your email here" value="dadoh@gmail.com">
                                                            </div>
                                                        </div>                                    
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="website1">Username</label>
                                                                <input type="text" class="form-control mb-4" id="website1" placeholder="Izina ryo kwinjira">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <!-- <script src="<?=base_url()?>assets/plugins/tagInput/tags-input.js"></script> -->
