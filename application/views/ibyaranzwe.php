    ...
    <div class="col-md-9" style="padding-right:30px" >
        ...
        if ($selected != null){
                ...
                <div class="social-feed-box">
                    ...
                    <div class="social-avatar">
                        <a href="" class="pull-left">
                            <img alt="image" src="<?=base_url()?>assets/assets/img/profile.png">
                        </a>
                        <div class="media-body">
                            <a href="#">
                                <?=$row->ldr_firstname.' '.$row->ldr_lastname;?>
                            </a>
                            <small class="text-muted"><?=date('l - F d, Y g:i a', $row->ann_created_date);?></small>
                        </div>
                    </div>
                    <div class="social-body">
                        ...
                        <img src="<?=base_url().$row->ann_pic;?>" class="img-responsive" alt="Image Not Currently Available">
                    </div>
            ...
            <div class="infobox-1">
                ...
                <h5 class="info-heading">Nta Byaranzwe bishya bigaragara hano.</h5>
