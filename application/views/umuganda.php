                        ...
                        <div class="widget-content widget-content-area br-6">
                            ...
                            if ($selected != null){
                                ...
                                <table id="default-ordering" border=1  style="width:100%; color:#000; font-family:arial">
                                    ...
                                    foreach ($selected as $row){
                                        ...
                                        <tr><td><?=$x;?></td>
                                            ...
                                            <td><?=$row->umg_abagore+$row->umg_abagabo+$row->umg_urubyiruko;?></td>
                                            <td><?=date('d-M-Y', strtotime($row->umg_date))?></td>
                                            <td><?=number_format($row->umg_agaciro,0,'.',',').' Rwf';?></td>
                                            <td class="text-center"><a href="<?=base_url()?>family/amafoto/<?=$row->umg_id ;?>"><button class="btn btn-primary btn-sm">Amafoto</button></a> </td>
                                        </tr>
                                        <?php
                                    }
                                    ?>
                                ...
                                <div class="infobox-1">
                                    ...
                                    <h5 class="info-heading">Nta Muganda n'umwe wari wandikwa muri iyi system.</h5>
