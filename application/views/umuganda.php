                            ...
                            <table id="default-ordering" border=1  style="width:100%; color:#000; font-family:arial">
                                ...
                                <tbody>
                                    <tr><td>1</td>
                                        ...
                                        <td>2011/04/25</td>
                                        <td>$320,800</td>
                                        <td class="text-center"><a href="<?=base_url()?>family/amafoto.php"><button class="btn btn-primary btn-sm">Amafoto</button></a> </td>
                                    </tr>
                                    <tr><td>2</td>
                                        ...
                                        <td>2011/07/25</td>
                                        <td>$170,750</td>
                                        <td class="text-center"><a href="<?=base_url()?>family/amafoto"><button class="btn btn-primary btn-sm">Amafoto</button></a> </td>
                                    </tr>
                                    <tr><td>3</td>
                                        <td>Ashton Cox</td>
