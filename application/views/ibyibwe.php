...
<div class="pull-right social-action dropdown">
            <button>
               <a href="<?=base_url()?>family/kwandika_ibyibwe"> <i class="fa fa-star"> MENYEKANISHA IBYIBWE</i></a>
            </button>
...
<h4>ABAJURA BIBYE SACCO MUMASAHA YIJORO</h4>
...
<p style="color:#000; font-family:arial; text-align: justify;">
            ...
            <img src="<?=base_url()?>assets/assets/img/thief.jpg" class="img-responsive">
</div>
...
<div class="social-body">
<h4>HAMAZE KWIBWA INGO 20 MUKWEZI KUMWE</h4>
<p style="color:#000; font-family:arial; text-align: justify;">
                Many desktop publishing packages and web page editors now use Lorem Ipsum as their
                default model text, and a search for 'lorem ipsum' will uncover many web sites still
                in their infancy. Packages and web page editors now use Lorem Ipsum as their
            ...
            <img src="<?=base_url()?>assets/assets/img/thief1.jpg" class="img-responsive">
