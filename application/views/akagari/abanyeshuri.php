	...
	<body>
		...
		<div class="page">
			...
			<div class="pcss3t pcss3t-effect-scale pcss3t-theme-1">
				...
				<label for="tab1"><i class="icon-bolt"></i>ABANA BIGA</label>
				
				<input type="radio" name="pcss3t" id="tab2" class="tab-content-2">
				<label for="tab2"><i class="icon-picture"></i>ABANA BATIGA</label>
              <ul>
                ...
                <table id="default-ordering" border=1  style="width:100%; color:#000; font-family:arial">
                                ...
                                <tbody>
                                    <tr><td>1</td>
                                        ...
                                        <td>2011/04/25</td>
                                        <td>$320,800</td>
										<td>System ArchitectSystem ArchitectSystem Architect</td>
                                    </tr>
                                    <tr><td>1</td>
                                        <td>Tiger Nixon</td>
                                        <td>System Architect</td>
