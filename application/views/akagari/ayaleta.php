...
<div class="col-lg-12 col-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div style="color:#000; font-weight:bold" class="widget-content widget-content-area">
                                    <?php echo form_open_multipart(site_url('akagari/do_upload_ikira'));?>
                                            ...
                                            <div class="item-timeline timeline-new" >
                                                ...
                                                <div class="t-content">
                                                    <div class="t-uppercontent">
                                                        <h5 style="color:#000; font-weight:bold"><?=$value->ama_title?> : <br><a href="<?=base_url()?>akagari/soma/<?=$value->ama_id?>"><span>Soma Itangazo</span></a></h5>
                                                    </div>
