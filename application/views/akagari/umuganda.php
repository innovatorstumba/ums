...
.panel-body {
 ...
 <div id="content" class="main-content">
            <div class="layout-px-spacing">
               ...
               ?> <h3 style="margin-left:20px">INYAMIBWA VILLAGE</h3>
               <table id="default-ordering" border=1  style="width:100%; color:#000; font-family:arial">
                                ...
                                <tbody>
                                    <tr><td>1</td>
                                        ...
                                        <td>2011/04/25</td>
                                        <td>$320,800</td>
                                        <td class="text-center"><a href="<?=base_url()?>akagari/amafoto.php"><button class="btn btn-primary btn-sm">Amafoto</button></a> </td>
                                    </tr>
                                    <tr><td>2</td>
                                        ...
                                        <td>2011/07/25</td>
                                        <td>$170,750</td>
                                        <td class="text-center"><a href="<?=base_url()?>akagari/amafoto"><button class="btn btn-primary btn-sm">Amafoto</button></a> </td>
                                    </tr>
                                    <tr><td>3</td>
                                        <td>Ashton Cox</td>
               ...
               else{  ?> <h3 style="margin-left:20px">INGANJI VILLAGE</h3>
                            <table id="default-ordering" border=1  style="width:100%; color:#000; font-family:arial">
                                <thead>
                                    <tr style="background-color:#f1f1f1"><th>No</th>
                                        <th>Igikorwa</th>
              ...
              <?php }}else{?>
                <h3 style="margin-left:20px">ALL VILLAGE</H3>
                            <table id="default-ordering" border=1  style="width:100%; color:#000; font-family:arial">
                                <thead>
                                    <tr style="background-color:#f1f1f1"><th>No</th>
                                        <th>Igikorwa</th>
