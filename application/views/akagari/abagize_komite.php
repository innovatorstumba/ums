	...
	<body>
		...
		<div class="page">
			...
			<div class="pcss3t pcss3t-effect-scale pcss3t-theme-1">
				...
				<label for="tab1"><i class="icon-bolt"></i>Urwego rw'umudugudu</label>
				
				<input type="radio" name="pcss3t" id="tab2" class="tab-content-2">
				<label for="tab2"><i class="icon-picture"></i>Urwego rw'akagari</label>
              <ul>
                    ...
                    <table id="zero-config" border=1 class="table table-striped"  style="width:100%; color:#000; font-family:arial">
                                ...
                                <tbody>
                                  <?php
                                  if (is_array($umudugudu)) {
                                    foreach ($umudugudu as $value) {
                                      @$i++;
                                      ?>
                                      <tr>
                                      <td><?=$i?></td>
                                      <td><?=$value->adm_firstname." ".$value->adm_lastname?></td>
                                      <td><?=$value->adm_phone?></td>
                                      <td><?=$value->roles_name?></td>
                                      <td><?=$value->village_name?></td></tr>
                                      <?php
                                    }
                                  }else {
                                    ?>
