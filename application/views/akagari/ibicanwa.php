	...
	<body>
		...
		<div class="page">
			...
			<div class="pcss3t pcss3t-effect-scale pcss3t-theme-1">
				...
				<label for="tab1"><i class="icon-bolt"></i>GAS</label>
				
				<input type="radio" name="pcss3t" id="tab2" class="tab-content-2">
				<label for="tab2"><i class="icon-picture"></i>AMAKARA</label>

				<input type="radio" name="pcss3t" id="tab3"class="tab-content-3">
				<label for="tab3"><i class="icon-bolt"></i>UMURIRO</label>
              ...
              <ul>
                ...
                <table id="alter_pagination" class="table table-hover" border=1  style="width:100%; color:#000; font-family:arial">
                                <thead>
                                    <tr style="background-color:#f1f1f1"><th>No</th>
                                        <th>AMAZINA</th>
                                        <th>IRANGAMUNTU</th>
