...
.panel-body {
 ...
 <div id="content" class="main-content">
            <div class="layout-px-spacing">
               ...
               </form><table id="default-ordering" border=1  style="width:100%; color:#000; font-family:arial">
                                <thead>
                                    ...
                                    foreach($data as $row)
                                      {
                                        ...
                                        ?>
                                        <tr><td><?=$cnt?></td>
                                            <td><?php echo $row->ldr_lastname; ?></td>
                                            <td><?php echo $row->ldr_nid; ?></td>
                                            <td><?php echo $row->ldr_phone; ?></td>
                                            <td><?=$row->ldr_house?></td>
                                            <td><?php echo $row->ldr_dob; ?></td>
                                            <td><?php echo $row->ldr_gender; ?></td>
                                            <td class="text-center"><a href="<?=base_url()?>akagari/kureba_umuryango/<?php echo $row->ldr_leader_id; ?>"><button class="btn btn-primary btn-sm">Fungura</button></a> </td>
                                        </tr>
                                      <?php
                                      }
                                }else {
