...
.panel-body {
 ...
 <div id="content" class="main-content">
            <div class="layout-px-spacing">
               ...
               $selected=$_GET['umu'];
               if($selected =='ubutwari'){
               ?> <h3 style="margin-left:20px">ISIBO Y'UBUTWARI</h3>
               <table id="default-ordering" border=1  style="width:100%; color:#000; font-family:arial">
                                <thead>
                                    <tr style="background-color:#f1f1f1"><th>No</th>
                                        ...
                                        <th>Itariki</th>
                                        <th>Agaciro</th>
                                        <th class="text-center dt-no-sorting">Fungura</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr><td>1</td>
                                        ...
                                        <td>2011/04/25</td>
                                        <td>$320,800</td>
                                        <td class="text-center"><a href="<?=base_url()?>umudugudu/amafoto.php"><button class="btn btn-primary btn-sm">Amafoto</button></a> </td>
                                    </tr>
                                    <tr><td>2</td>
                                        ...
                                        <td>2011/07/25</td>
                                        <td>$170,750</td>
                                        <td class="text-center"><a href="<?=base_url()?>umudugudu/amafoto"><button class="btn btn-primary btn-sm">Amafoto</button></a> </td>
                                    </tr>
                                    <tr><td>3</td>
                                        <td>Ashton Cox</td>
                                        ...
                                        <td>2009/01/12</td>
                                        <td>$86,000</td>
                                        <td class="text-center"><button class="btn btn-primary btn-sm">Amafoto</button> </td>
                                    </tr>
                                    <tr><td>4</td>
                                        <td>Cedric Kelly</td>
               ...
               else{  ?> <h3 style="margin-left:20px">ISIBO Y'UBUMWE</h3>
                            <table id="default-ordering" border=1  style="width:100%; color:#000; font-family:arial">
                                <thead>
                                    <tr style="background-color:#f1f1f1"><th>No</th>
                                        <th>Igikorwa</th>
              ...
              <?php }}else{?>
                <h3 style="margin-left:20px">AMASIBO YOSE</H3>
                            <table id="default-ordering" border=1  style="width:100%; color:#000; font-family:arial">
                                <thead>
                                    <tr style="background-color:#f1f1f1"><th>No</th>
                                        <th>Igikorwa</th>
