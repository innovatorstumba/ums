                                ...
                                foreach($data as $row)
                                  {
                                    ...
                                    ?>
                                    <tr><td><?=$cnt?></td>
                                        <td><?php echo $row->ldr_firstname; ?> <?php echo $row->ldr_lastname; ?></td>
                                        <td><?php echo $row->ldr_nid; ?></td>
                                        <td><?php echo $row->ldr_phone; ?></td>
                                        <td><?=$row->ldr_house?></td>
                                        <td><?php echo $row->ldr_dob; ?></td>
                                        <td><?php echo $row->ldr_gender; ?></td>
                                        <td class="text-center"><a href="<?=base_url()?>umudugudu/kureba_umuryango/<?php echo $row->ldr_leader_id; ?>"><button class="btn btn-primary btn-sm">Fungura</button></a> </td>
                                    </tr>
                                  <?php
                                  }
                                ?>
