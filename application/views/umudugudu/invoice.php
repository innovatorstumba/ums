                                                        ...
                                                        <div class="inv--detail-section inv--customer-detail-section">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xl-4 col-lg-5 col-md-6 col-sm-8 align-self-center order-sm-0 order-1 inv--payment-info">
                                                                    <h6 class=" inv-title">Uburyo bwo kwishyura:</h6>
                                                                </div>
                                                                
                                                                <div class="col-xl-8 col-lg-7 col-md-6 col-sm-4">
                                                                    <p class="inv-customer-name">Huska Jafar</p>
                                                                    <p class="inv-street-addr">Kigali, Kicukiro</p>
                                                                    <p class="inv-email-address">huska@gmail.com</p>
                                                                    <p class="inv-email-address">+25078434955</p>
                                                                </div>
                                                                
                                                                <div class="col-xl-4 col-lg-5 col-md-6 col-sm-8 col-12 order-sm-0 order-1">
                                                                    <div class="inv--payment-info">
                                                                        <p><span class=" inv-subtitle">Bank Name:</span> <span>EQUITY BANK</span></p>
                                                                        ...
                                                                        <p><span class=" inv-subtitle">Country: </span> <span>RWANDA</span></p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <table class="table">
                                                                    <thead class="">
                                                                        <tr>
                                                                            ...
                                                                            <th class="text-right" scope="col">AMEZI</th>
                                                                            <th class="text-right" scope="col">AMAFARANGA</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>1</td>
                                                                            <td>AMAFARANGA YISUKU</td>
