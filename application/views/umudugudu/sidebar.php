    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu md-visible">
                <a href="<?=base_url()?>umudugudu/chat" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <a href="#umuganda" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                ...
                <ul class="collapse submenu list-unstyled" id="umuganda" data-parent="#accordionExample">
                    <li>
                        <a href="<?=base_url()?>umudugudu/umuganda"> Kureba Imiganda </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umudugudu/kuzuza_umuganda"> Kuzuza Umuganda  </a>
                    </li>
            ...
            <a href="#starter-kit" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                ...
                <ul class="collapse submenu list-unstyled" id="starter-kit" data-parent="#accordionExample">
                    <li>
                        <a href="<?=base_url()?>umudugudu/ayaleta"> Ayaleta </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umudugudu/amatangazo"> Ayokurangisha  </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umudugudu/ibyaranzwe"> Ibyaranzwe  </a>
                    </li>                      
            ...
            <li class="menu">
                ...
                <li>
                        <a href="<?=base_url()?>umudugudu/ongeramo_umuryango"> ONGERAMO UMURYANGO </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umudugudu/imiryango"> Kureba Imiryango </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umudugudu/abagabo"> Abagabo</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umudugudu/abagore"> Abagore</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umudugudu/abana"> Abana</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umudugudu/urubyiruko"> Urubyiruko</a>
                    </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="elements" data-parent="#accordionExample">
                    <li>
                        <a href="<?=base_url()?>umudugudu/guhindura_umwirondoro"> Ifoto Ikuranga </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umudugudu/citizen"> Umwirondoro wanjye </a>
                    </li>
                  
                </ul>
            </li>
            <li class="menu">
                <a href="<?=base_url()?>umudugudu/abaturage" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="datatables" data-parent="#accordionExample">
                    <li>
                        <a href="<?=base_url()?>umudugudu/abashyitsi"> Abashyitsi</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umudugudu/ibyibwe"> Ibyibwe</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umudugudu/ayaleta"> Amatangazo y'umutekano</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umudugudu/umutekano"> Umusanzu W'umutekano</a>
                    </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="forms" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="<?=base_url()?>umudugudu/akagoroba"> Umugoroba w'ababyeyi </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>umudugudu/isuku"> Umusanzu w'isuku</a>
                    </li>
                </ul>
            </li>
            ...
            <a href="#users" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                ...
                <ul class="collapse submenu list-unstyled" id="users" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="<?=base_url()?>umudugudu/igiceri"> Igiceri Porogaramu </a>
                    </li>                            
            ...
            <a href="#komite" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                ...
                <ul class="collapse submenu list-unstyled" id="komite" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="<?=base_url()?>umudugudu/abagize_komite"> Abagize komite </a>
                    </li>   
                    <li>
                        <a href="<?=base_url()?>umudugudu/kwandika_umuyobozi"> Ongeramo Umuyobozi</a>
                    </li>   
                    <li>
                        <a href="<?=base_url()?>umudugudu/kongeramo_isibo"> Ongeramo Isibo </a>
                    </li>                            
            ...
            <a href="#ibarura" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                ...
                <ul class="collapse submenu list-unstyled" id="ibarura" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="<?=base_url()?>umudugudu/girinka"> Girinka </a>
                    </li>   
                    <li>
                        <a href="<?=base_url()?>umudugudu/ibicanwa">Ibicinwa</a>
                    </li>   
                    <li>
                        <a href="<?=base_url()?>umudugudu/akarima">Akarima Kigikoni</a>
                    </li>  
                    <li>
                        <a href="<?=base_url()?>umudugudu/agatanda">Agatanda</a>
                    </li>  
                    <li>
                        <a href="<?=base_url()?>umudugudu/abanyeshuri">Abanyeshuri</a>
                    </li>  
                    <li>
                        <a href="<?=base_url()?>umudugudu/abakozi">Abakozi</a>
                    </li>                            
